...
// Desenhar o menu de Intro para o jogo;
    // Inserir palavras nas WordList; 
        ...
        // Escrever num ficheiro e Ler do mesmo
        // Sortear uma palavra random e mostrar o seu tipo
    // Escolher a dificuldade (Facil; Normal; Dificil;)
        // Atribuir a vida ao jogador (nr de tentativas baseado por dificuldade)
    // Escolher JOGAR
        // Interface de Jogo
